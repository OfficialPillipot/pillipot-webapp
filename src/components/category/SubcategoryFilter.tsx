...
export default function SubcategoryFilter({ 
  ...
  return (
    <div className="flex items-center gap-3 overflow-x-auto no-scrollbar py-3 px-4 bg-white/80 backdrop-blur-md border-b border-gray-100/50 sticky top-[calc(3.5rem+3.5rem)] md:top-[calc(4rem+3.5rem)] z-30">
      <button
